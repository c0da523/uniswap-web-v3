import { ChainId, Currency, V3_CORE_FACTORY_ADDRESSES } from '@repo/sdk-core'
import { FeeAmount, nearestUsableTick, Pool, TICK_SPACINGS, tickToPrice } from '@repo/v3-sdk'
import { useAllV3TicksQuery } from '@src/graphql/thegraph/__generated__/types-and-hooks'
import { TickData, Ticks } from '@src/graphql/thegraph/AllV3TicksQuery'
import { apolloClient } from '@src/graphql/thegraph/apollo'
