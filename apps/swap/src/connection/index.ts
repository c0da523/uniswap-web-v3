...
import UNISWAP_LOGO from 'assets/svg/logo.svg?url'
import COINBASE_ICON from 'assets/wallets/coinbase-icon.svg?url'
import UNIWALLET_ICON from 'assets/wallets/uniswap-wallet-icon.png'
import WALLET_CONNECT_ICON from 'assets/wallets/walletconnect-icon.svg?url'
