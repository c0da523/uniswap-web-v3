import { Chain, NftCollection, useRecentlySearchedAssetsQuery } from '@src/graphql/data/__generated__/types-and-hooks'
import { SearchToken } from '@src/graphql/data/SearchTokens'
import { logSentryErrorForUnsupportedChain, supportedChainIdFromGQLChain } from '@src/graphql/data/util'
