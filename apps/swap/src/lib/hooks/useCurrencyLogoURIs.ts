...
import AvaxLogo from '../../assets/svg/avax_logo.svg?url'
import BnbLogo from '../../assets/svg/bnb-logo.svg?url'
import CeloLogo from '../../assets/svg/celo_logo.svg?url'
import MaticLogo from '../../assets/svg/matic-token-icon.svg?url'
