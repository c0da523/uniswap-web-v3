...
export function isStagingEnv(): boolean {
  ...
  return Boolean(import.meta.env.REACT_APP_STAGING)
}

export function isProductionEnv(): boolean {
  return import.meta.env.NODE_ENV === 'production' && !isStagingEnv()
}
...
export function isSentryEnabled(): boolean {
  ...
  return import.meta.env.REACT_APP_SENTRY_ENABLED === 'true'
}
